...
export function Chatbot() {
  ...
  return (
    <div className="flex flex-col justify-center w-full max-w-3xl mx-auto">
      ...
      >
        <div
          className="flex-1 overflow-auto p-6 bg-white custom-scrollbar"
          style={{
            scrollbarWidth: 'thin',
        ...
        >
          <div className="relative flex-1">
            <Textarea
              ...
              className="rounded-lg pr-12 min-h-[64px] border border-gray-300 w-full focus:ring-2 focus:ring-black focus:border-black"
              rows={1}
              value={input}
